        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                "Error",
                "An error occurred while deleting bank account. Please try again later."
              );
            }
          },
        },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.propertyContainer}>
        ...
        <Text style={styles.propertyText}>
          Set up your bank accounts so you can perform faster withdrawals.
        </Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        {bankRecords && bankRecords.length > 0 ? (
              ...
              <View style={styles.bankCardContent}>
                <View style={styles.bankCardHeader}>
                  ...
                  <View style={styles.accountDetails}>
                    ...
                    <Text style={styles.bankCardBankName}>
          ...
          <View style={styles.bankAddedcontainer}>
            <Text style={styles.bankAddedInfo}>
