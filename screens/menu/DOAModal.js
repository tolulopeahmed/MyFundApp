...
<SafeAreaView>
      <ScrollView style={styles.scrollView} >
        ...
        <Text style={styles.bodyText}>
          This Deed of Agreement ("Agreement") is entered into on this <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>{day} day of {month}, {year} </Text>(the "Effective Date") by and
          between:
        </Text>

        <SectionTitle>PARTIES</SectionTitle>
        <Text style={styles.bodyText}>
          WHEREAS, Party A <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>({userInfo.firstName} {userInfo.lastName})</Text> is a registered user of the MyFund platform and intends to purchase
          one of the listed properties on the platform through the MyFund App.
        </Text>
        <Text style={styles.bodyText}>
          WHEREAS, Party B <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>(MyFund)</Text> operates the MyFund platform and provides property investment opportunities to registered users, and operating at 13, Gbajabiamila Street, Ayobo, Lagos and registed officially as <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>Vcorps Systems Limited</Text> with Registered number RC 1508170. And also via the webapp at www.myfundmobile.com. And can be contacted via the office line: +2349032719396.
        </Text>

        <SectionTitle>PROPERTY COST AND RENTAL INCOME</SectionTitle>
        <Text style={styles.bodyText}>
          1.1 Party A will pay the amount stated as cost on the property and agrees to a <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>5%</Text> charge for processing fee.
        </Text>
        <Text style={styles.bodyText}>
          1.2 Party A acknowledges that they will earn <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>70%</Text> of the rental income generated by the property purchased through the MyFund
          platform, and Party B shall deduct <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>30%</Text> as for managment fees. The rental income will be earned annually as long as the property is
        ...
        <Text style={styles.bodyText}>
          2.1 If the selected property has a waiting period attached to it, and party A wants to pay ahead as an early mover, Party A agrees to a waiting period of <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>9 months</Text> for the property purchased. Party B shall not list properties that are not
        ...
        <Text style={styles.bodyText}>
          ...
          sale will be credited to Party A's wallet upon completion. A processing fee, typically between <Text style={{fontFamily: 'proxima', color: isDarkMode? 'yellow':'#4C28BC'}}>10%</Text> of the sale price, will be
