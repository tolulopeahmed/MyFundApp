          ...
          >
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalSubText}>
                ...
                {"\n"} {"\n"}As part of helping you grow your funds to own
                properties and developing your savings habit, you'll need to set
                a savings goal.
              </Text>
              ...
              <View style={styles.dropdown}>
                ...
                >
                  <Picker.Item
                    label="Real Estate (MyFund Hostels)"
                    value="Real Estate"
                  />
                ...
                <TextInput
                  ...
                  onBlur={() => {
                    ...
                    if (numericAmount < 1000000) {
                      Alert.alert(
                        "Invalid Amount",
                        "The minimum amount is 1,000,000. Please enter a valid amount."
                      );
                    }
                  }}
                />
              ...
              <View style={styles.presetAmountsContainer}>
                <View style={styles.presetAmountColumn}>
                  ...
                  <TouchableOpacity
                    style={styles.presetAmountButton}
                    onPress={() => handleAmountButtonPress(10000000)}
                  >
                ...
                <View style={styles.presetAmountColumn}>
                  ...
                  <TouchableOpacity
                    style={styles.presetAmountButton}
                    onPress={() => handleAmountButtonPress(15000000)}
                  >
                ...
                <View style={styles.presetAmountColumn}>
                  ...
                  <TouchableOpacity
                    style={styles.presetAmountButton}
                    onPress={() => handleAmountButtonPress(30000000)}
                  >
