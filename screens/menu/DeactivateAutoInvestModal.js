...
const DeactivateAutoInvestModal = ({
  navigation,
  route,
  frequency,
  ...
  const handleConfirmDeactivateAutoInvest = async () => {
    ...
    try {
      const response = await axios.post(
        `${ipAddress}/api/deactivate-autoinvest/`,
        {
      ...
      if (
        ...
        Alert.alert(
          ...
          "Your AutoInvest has been deactivated successfully."
        );
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      <PinModal
        ...
        useMode="validate"
        onPinSubmit={handleConfirmDeactivateAutoInvest}
      />
    </>
  );
};
