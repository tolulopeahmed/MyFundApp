...
const Save = ({ navigation, route }) => {
  ...
  const [deactivateAutoSaveModalVisible, setDeactivateAutoSaveModalVisible] =
    useState(false);
  ...
  const percentage = () => {
    ...
    const totalAmount =
      parseFloat(accountBalances.savings) +
      parseFloat(accountBalances.investment);
  ...
  const handleConfirmDeactivateAutoSave = () => {
    ...
    AsyncStorage.removeItem("autoSaveSettings")
      ...
      .catch((error) =>
        console.error("Error removing auto-save status:", error)
      );
  };
  ...
  console.log(
    "TopSaversData.Individual Percentage:",
    topSaversData.current_user.individual_percentage
  );
                ...
                <View style={styles.propertyContainer}>
                  ...
                  <View style={styles.progressBarContainer}>
                    <Text style={styles.propertyText}>
                      {`Congratulations on reaching your goal of ₦${formatWithCommas(
                        roundToNearestThousand(userInfo.savings_goal_amount)
                      )} for your `}
                  ...
                  <View style={styles.progressBarContainer}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                      <Text style={styles.propertyText}>
                        ...
                        {`You should be saving ₦${formatWithCommas(
                          roundToNearestThousand(
                            userInfo.savings_goal_amount /
                              (userInfo.time_period * 12)
                          )
                        )}/month to reach `}
                        <Text style={styles.goalText}>{`₦${formatWithCommas(
                          roundToNearestThousand(userInfo.savings_goal_amount)
                        )}`}</Text>
                        {` for your ${userInfo.preferred_asset} investment in ${userInfo.time_period} years. And you're now `}
                        <Text style={styles.percentageText}>{`${percentage(
                          0
                        ).toFixed(1)}%`}</Text>
            ...
            <Swiper>
              <View style={styles.propertyContainer}>
                ...
                <View style={styles.progressBarContainer}>
                  <Text style={styles.propertyText}>
                    ...
                    100 ? (
                      <Text>
                        ...
                        } You're currently one of the top savers in ${currentMonth}. 🥳🍾🎉🎊 Keep saving to earn more rewards.`}
                        <Text
                          style={{
                            fontFamily: "proxima",
                            color: isDarkMode ? "#6E3DFF" : "#4C28BC",
                          }}
                          onPress={() => handleSeeTopSavers()}
                        >
                          {" "}
                          See TopSavers...
                        </Text>
                  ...
                  <ProgressBar
                    progress={
                      (topSaversData?.current_user.individual_percentage || 0) /
                      100
                    }
                    color="green"
                    height={6}
        ...
        >
          <View style={styles.savingsLine1}>
            ...
            <Text style={styles.greyText}>
              Total Savings <Text style={styles.rateText}>@10% p.a.</Text>{" "}
            </Text>
          </View>
          ...
          <View style={styles.autoSaveContainer}>
            <Ionicons
              ...
              style={[
                styles.autoSaveText,
                autoSaveSettings.active ? styles.greenText : styles.grayText,
              ]}
            />
            <Text
              style={[
            ...
            <DeactivateAutoSaveModal
              ...
              setDeactivateAutoSaveModalVisible={
                setDeactivateAutoSaveModalVisible
              }
        ...
        <View>
          {autoSaveSettings.active ? (
            <Text style={styles.autoSaveSetting}>
              You're AutoSaving ₦{autoSaveSettings.amount}{" "}
              {autoSaveSettings.frequency}{" "}
              <Ionicons
            ...
            <Text style={styles.autoSaveText} alignSelf="center" marginTop={10}>
              AutoSave is OFF: Use the switch above to turn ON
            </Text>
          )}
        </View>
            ...
            {userTransactions.some((transaction) =>
              ...
              <View style={styles.noTransactionsContainer}>
                <Text style={styles.noTransactionsMessage}>
                  You're yet to make any Savings.
                </Text>
              </View>
            )}
          </View>
