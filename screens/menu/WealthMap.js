...
const WealthMap = ({ navigation, firstName }) => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.propertyContainer}>
        ...
        <View style={styles.progressBarContainer}>
          <Text style={styles.propertyText}>
            Based on your usage, your financial status is{" "}
            <Text style={{ fontFamily: "proxima", color: "green" }}>
              Stage {currentStage.stage}: {currentStage.text.toUpperCase()}
            </Text>
            . Keep growing your funds to move up the 9 stages to financial
            freedom.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.savingsContainer}>
        ...
        <View style={styles.amountContainer}>
          <Text
            ...
            numberOfLines={1}
          >
            {currentStage ? currentStage.text : "Unknown"}
          </Text>
        </View>
      ...
      <Image
        source={stageImageSources[currentStage.stage]}
        style={styles.image}
      />
