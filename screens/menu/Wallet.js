        ...
        <View style={styles.propertyContainer}>
          ...
          <View style={styles.progressBarContainer}>
            <Text style={styles.propertyText}>
              Withdraw from your Wallet at any time into your bank account or
              give your{" "}
              <Text style={{ fontFamily: "proxima" }}>wallet ID </Text> to other
              MyFund users to receive gift funds from them.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.savingsContainer}>
          ...
          <View style={styles.amountContainer}>
            ...
            <Text style={styles.savingsAmount}>
              {Math.floor(accountBalances.wallet)}
            </Text>
            <Text style={styles.decimal}>
              .{String(accountBalances.wallet).split(".")[1]}
            </Text>
          </View>
          <View style={styles.autoSaveContainer}></View>
        </View>
