...
const images = [require("./refer.png"), require("./howtoearn.png")];
...
const ReferAndEarn = ({ navigation, firstName }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Subtitle>
        Get your friends to signup with your email so you both earn
      </Subtitle>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View flexDirection="row" alignSelf="center">
          <Text style={styles.referralText}>
            Referral ID: <Text style={styles.referralID}>{referralID}</Text>
          </Text>
            ...
            <View style={styles.column}>
              <Text style={styles.text}>
                ...
                <Text style={{ fontFamily: "ProductSans" }}>
                  (
                  {totalConfirmedReferrals < 10
                    ? `0${totalConfirmedReferrals}`
              ...
              {userTransactions.some((transaction) =>
                ...
                <View style={styles.noTransactionsContainer}>
                  <Text style={styles.noTransactionsMessage}>
                    You're yet to make any referrals.
                  </Text>
                </View>
              )}
            </View>
