...
const PropertyList = ({ navigation, properties }) => {
  ...
  const [sellPropertyModalVisible, setSellPropertyModalVisible] =
    useState(false); // define modalVisible state
        ...
        <View style={styles.propertyContainer}>
          ...
          <View style={styles.progressBarContainer}>
            <Text style={styles.propertyText}>
              The properties you've bought will appear here and{" "}
              <Text style={{ color: isDarkMode ? "#6E3DFF" : "#4C28BC" }}>
                the yearly rental income
              </Text>
              . Buy more to earn more. For special package deals, kindly contact
              admin
            </Text>
          </View>
        </View>
        ...
        <View style={styles.savingsContainer}>
          <View style={styles.savingsLine1}>
            ...
            <Text style={styles.greyText}>
              ...
              <Text style={styles.rateText}>@30%+ p.a.</Text>{" "}
            </Text>
          </View>
            ...
            {userTransactions.some((transaction) =>
                  ...
                  <View key={index} style={styles.transactionItem}>
                    ...
                    <View style={styles.transactionAmountContainer}>
                      ...
                      >
                        ...
                        <Text>
                          {Math.floor(
                            transaction.rent_earned_annually
                          ).toLocaleString()}
                          <Text style={{ fontSize: 12 }}>
                            .{String(transaction.amount).split(".")[1]}
                          </Text>
                      ...
                      >
                        <Text style={styles.sellPropertyButtonText}>
                          Sell Property
                        </Text>
                      </TouchableOpacity>
                    </View>
              ...
              <View style={styles.noTransactionsContainer}>
                <Text style={styles.noTransactionsMessage}>
                  You're yet to acquire a property.
                </Text>
              </View>
            )}
          </View>
