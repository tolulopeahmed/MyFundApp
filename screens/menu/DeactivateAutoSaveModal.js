...
const DeactivateAutoSaveModal = ({
  navigation,
  route,
  frequency,
  deactivateAutoSaveModalVisible,
  onConfirm,
  ...
  const handleConfirmDeactivateAutoSave = async () => {
    ...
    try {
      const response = await axios.post(
        `${ipAddress}/api/deactivate-autosave/`,
        {
      ...
      if (
        ...
        Alert.alert(
          ...
          "Your AutoSave has been deactivated successfully."
        );
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      <PinModal
        ...
        useMode="validate"
        onPinSubmit={handleConfirmDeactivateAutoSave}
      />
    </>
  );
};
