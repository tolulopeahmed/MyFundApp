    ...
    return topSaversData?.top_savers.map((saver, index) => (
      <View
        ...
        style={[
          ...
          saver.email === userInfo.email && {
            backgroundColor: isDarkMode ? "#2B1667" : "#EAE2FC",
            flex: 1,
          },
        ]}
      >
        ...
        <View style={styles.medalsContainer}>
          {index < 3 && (
            ...
            <MaterialIcons
              ...
              color={
                index === 0 ? "#FFD700" : index === 1 ? "silver" : "#CD7F32"
              }
              size={24}
            />
          )}
        ...
        <Ionicons
          name={
            ...
            topSaversData?.top_savers.findIndex(
              (saver) => saver.email === userInfo.email
            ) < 3
              ? "trophy-outline"
              : "podium-outline"
          }
            ...
            <Text style={{ fontFamily: "proxima", color: "#4C28BC" }}>
              <Text style={styles.propertyText}>
                ...
                topSaversData?.top_savers.findIndex(
                  ...
                  <Text>
                    {""}Congratulations{" "}
                    {userInfo?.firstName ? `${userInfo.firstName},` : ""} You're
                    currently one of the top savers in {currentMonth}. 🥳🍾🎉🎊
                    Keep saving to earn more as a top saver.
                  </Text>
                ) : (
                  <Text>
                    Hey{" "}
                    {userInfo?.firstName
                      ? `${userInfo.firstName}, you're `
                      : ""}
                    <Text style={{ fontFamily: "proxima", color: "green" }}>
                      {topSaversData?.current_user.individual_percentage.toFixed(
                        0
                      )}
                      %
                    </Text>{" "}
                    from being one of the top savers in {currentMonth}. Keep
                    growing your funds to earn more as a top saver.
                  </Text>
                )}
              </Text>
            </Text>
        ...
        <View style={styles.profileImageContainer}>
          ...
          <View style={styles.percentageBackground}>
            <Text style={styles.percentageText}>
              ...
              <Text style={{ fontSize: 7, fontFamily: "karla" }}>%</Text>
            </Text>
          </View>
        </View>
