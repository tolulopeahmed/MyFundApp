  ...
  return (
    <>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <View style={styles.buttonsContainer}>
                    <TouchableOpacity
                      ...
                      onPress={openTransactionPinModal}
                    ...
                    >
                      {processing ? (
                        <>
                          ...
                          >
                            {" "}
                            Activating AutoSave... Please wait...
                          </Text>
                        </>
                      ) : (
                        <Text style={styles.primaryButtonText}>
                          Activate AutoSave Now!
                        </Text>
                      )}
                    </TouchableOpacity>
                  </View>
      ...
      <PinModal
        ...
        useMode="validate"
        onPinSubmit={handleConfirmAutoSave}
      />
    </>
  );
};
