...
const Sponsorship = ({ navigation, route }) => {
  ...
  const handleConfirmAutoInvest = (amount, frequency) => {
    ...
    AsyncStorage.setItem("autoInvestSettings", "true")
      ...
      .catch((error) =>
        console.error("Error saving auto-invest status:", error)
      );
  };
  ...
  const handleConfirmDeactivateAutoInvest = () => {
    ...
    AsyncStorage.removeItem("autoInvestSettings")
      ...
      .catch((error) =>
        console.error("Error removing auto-invest status:", error)
      );
  };
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContainer}>
          ...
          <TouchableOpacity
            style={styles.bell}
            onPress={() => navigation.naviage("Notifications")}
          >
            <Ionicons
              name="notifications-outline"
              size={22}
              style={{ color: isDarkMode ? "#6E3DFF" : "#4C28BC" }}
            />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Title>Sponsor</Title>
        <Subtitle>
          Earn 20% p.a. every 6 months investing multiples of N100,000
        </Subtitle>
        ...
        <View style={styles.propertyContainer}>
          ...
          <View style={styles.progressBarContainer}>
            <Text style={styles.propertyText}>
              ...
              sponsoring any of our National Hostel Projects. Multiples of
              ₦100,000.
            </Text>
          </View>
        </View>
        ...
        >
          <View style={styles.savingsLine1}>
            ...
            <Text style={styles.greyText}>
              Total Investment <Text style={styles.rateText}>@15-20% p.a.</Text>{" "}
            </Text>
          </View>
          ...
          <View style={styles.autoSaveContainer}>
            <Ionicons
              ...
              style={[
                styles.autoSaveText,
                autoInvestSettings.active ? styles.greenText : styles.grayText,
              ]}
            />
            <Text
              style={[
        ...
        <View>
          {autoInvestSettings.active ? (
            <Text style={styles.autoSaveSetting}>
              You're AutoInvesting ₦{autoInvestSettings.amount}{" "}
              {autoInvestSettings.frequency}{" "}
              <Ionicons
            ...
            <Text style={styles.autoSaveText} alignSelf="center" marginTop={10}>
              AutoInvest is OFF: Use the switch above to turn ON
            </Text>
          )}
        </View>
            ...
            {userTransactions.some((transaction) =>
              ...
              <View style={styles.noTransactionsContainer}>
                <Text style={styles.noTransactionsMessage}>
                  You're yet to make an investment.
                </Text>
              </View>
            )}
          </View>
