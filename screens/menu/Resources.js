...
const Resources = ({ navigation }) => {
  ...
  const handleBuyNowClick2 = () => {
    const buyNowUrl =
      "https://flutterwave.com/pay/fhis21?_ga=2.157473722.1833356926.1651484081-1989222362.1651484081";
    Linking.openURL(buyNowUrl);
  };

  const handleBuyNowClick3 = () => {
    const buyNowUrl =
      "https://drive.google.com/drive/folders/1Gg25GSiQ09of4iQ54if6PlWSTnp5Pft0?usp=share_link";
    Linking.openURL(buyNowUrl);
  };
      ...
      <ScrollView style={styles.container}>
        <View style={styles.itemContainer}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <Text style={styles.subText1}>
              Identify and learn what to do to move up the 9 steps to financial
              freedom especially how to earn, save and acquire properties for
              rental income. {"\n"} {"\n"}It comes with bonus materials (audios
              and video links inside) and an opportunity to share profit. Enjoy!
            </Text>
        ...
        <View style={styles.itemContainer}>
          ...
          <View style={styles.detailsContainer}>
            <Text style={styles.headerText2}>
              Wealth Leadership Academy (Season 1)
            </Text>
            <Text style={styles.subText1}>
              Enjoy the Multiple Skills of Income Session of the Wealth
              Leadership Academy Season 1
            </Text>
        ...
        <View style={styles.itemContainer}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <Text style={styles.subText1}>
              A straightforward practical guide on how to Earn, Save and Invest
              (videos)
            </Text>
        ...
        <View style={styles.itemContainer}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <Text style={styles.subText1}>
              Here are ways you probably didn't know you can earn with MyFund.
              {"\n"} {"\n"}The fifth way is long-term but it's permanent income.{" "}
            </Text>
