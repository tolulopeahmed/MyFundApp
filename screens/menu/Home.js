      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.profileImageContainer}>
              ...
              {currentStage && (
                <View style={styles.wealthStageCircle}>
                  <Text style={styles.wealthStageText}>
                    {currentStage.stage}
                  </Text>
                </View>
              )}
        ...
        <View style={styles.propertyContainer}>
          ...
          <Text style={styles.propertyText}>
            ...
            , you'll earn{" "}
            <Text style={{ fontFamily: "proxima" }}>13% p.a.</Text> on your{" "}
            <Text style={{ fontFamily: "nexa", fontSize: 12 }}>SAVINGS</Text>{" "}
            and <Text style={{ fontFamily: "proxima" }}>20% p.a.</Text> on your{" "}
            <Text style={{ fontFamily: "nexa", fontSize: 12 }}>
              INVESTMENTS
            </Text>{" "}
            (credited to your wallet) until you've saved enough to buy
            properties and earn lifetime rent. So, keep growing your funds.
          </Text>
        </View>
        ...
        >
          ...
          >
            <View style={styles.savingsLine1}>
              ...
              <Text style={styles.greyText}>
                TOTAL SAVINGS
                <Text style={styles.rateText}> @13% p.a.</Text>{" "}
              </Text>
            </View>
              ...
              {showBalances ? (
                <>
                  ...
                  <Text style={styles.decimal}>
                    .{String(accountBalances.savings).split(".")[1]}
                  </Text>
                </>
              ) : (
          ...
          >
            <View style={styles.savingsLine1}>
              ...
              <Text style={styles.greyText}>
                TOTAL INVESTMENTS
                <Text style={styles.rateText}> @20% p.a.</Text>{" "}
              </Text>
            </View>
            <View style={styles.amountContainer}>
              <Text style={styles.dollarSign}>₦</Text>
              ...
              {showBalances ? (
                <>
                  ...
                  <Text style={styles.decimal}>
                    .{String(accountBalances.investment).split(".")[1]}
                  </Text>
                </>
              ) : (
          ...
          >
            <View style={styles.savingsLine1}>
              ...
              <Text style={styles.greyText}>
                ...
                <Text style={styles.rateText}> @yearly rent</Text>{" "}
              </Text>
            </View>
            <View style={styles.amountContainer}>
              {showBalances ? (
          ...
          >
            <View style={styles.savingsLine1}>
              ...
              <Text style={styles.greyText}>
                TOTAL WALLET
                <Text style={styles.rateText}> (My Earnings)</Text>{" "}
              </Text>
            </View>
            <View style={styles.amountContainer}>
              <Text style={styles.dollarSign}>₦</Text>
              {showBalances ? (
                <>
                  <Text
                    style={styles.savingsAmount4}
                    adjustsFontSizeToFit={true}
                    numberOfLines={1}
                  >
                    {Math.floor(accountBalances.wallet).toLocaleString()}
                  </Text>
                  <Text style={styles.decimal}>
                    .{String(accountBalances.wallet).split(".")[1]}
                  </Text>
                </>
              ) : (
        ...
        <View style={styles.todoContainer}>
          ...
          <View style={styles.todoList1}>
            <TouchableOpacity
              style={[
                styles.todoButton,
                autoInvestSettings.active && styles.disabledButton,
              ]}
          ...
          <View style={styles.todoList1}>
            <TouchableOpacity
              style={[
                styles.todoButton,
                (kycStatus === "Pending..." && styles.disabledButton) ||
                  (kycStatus === "Updated!" && styles.disabledButton) ||
                  (kycStatus === "updated" && styles.disabledButton),
              ]}
              ...
              {kycStatus === "Updated!" || kycStatus === "updated" ? (
                <>
                  ...
                  <Text style={styles.todoText}>
                    KYC: <Text style={styles.disabledText}>Updated!</Text>
                  </Text>
                  <Ionicons
                    name="checkmark-circle"
                    size={24}
                ...
                <>
                  ...
                  />
                  <Text style={styles.todoText}>
                    Update KYC: <Text>(Not yet started)</Text>
                  </Text>
                </>
              )}
            </TouchableOpacity>
            ...
            >
              ...
              <Pressable onPress={() => navigation.push("WealthMap")}>
                <Text style={styles.todoText2}>
                  {currentStage ? currentStage.text.toUpperCase() : "Unknown"}
                </Text>
              </Pressable>
            </View>
          </View>
          ...
          <View style={styles.transactionsContainer}>
            {userTransactions.some((transaction) =>
              [
                ...
                "QuickInvest",
                "AutoInvest",
                "Withdrawal (Savings > Investment)",
                "Withdrawal (Investment > Savings)",
                "Withdrawal (Wallet > Savings)",
                "Withdrawal (Wallet > Investment)",
                "Withdrawal (Savings > Bank)",
                "Withdrawal (Investment > Bank)",
                "Sent to User",
                      ...
                      >
                        ...
                        <Text>
                          ...
                          <Text style={{ fontSize: 12 }}>
                            .{String(transaction.amount).split(".")[1]}
                          </Text>
                        </Text>
                      </Text>
                    </View>
              ...
              <View style={styles.noTransactionsContainer}>
                <Text style={styles.noTransactionsMessage}>
                  You're yet to make any transactions.
                </Text>
              </View>
            )}
          </View>
