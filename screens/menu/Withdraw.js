      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <View style={styles.walletDetails}>
            ...
            <Text style={styles.walletMessage}>
              Immediate withdrawal attracts{" "}
              <Text style={{ color: "orange" }}>5%</Text> fee.
            </Text>
          ...
          <View style={styles.walletDetails}>
            ...
            <View style={styles.amountContainer2}>
              ...
              {showBalances ? (
                <>
                  <Text
                    style={styles.investmentBalance}
                    adjustsFontSizeToFit={true}
                    numberOfLines={1}
                  >
            ...
            <Text style={styles.walletMessage}>
              Immediate withdrawal attracts{" "}
              <Text style={{ color: "orange" }}>10%</Text> fee.
            </Text>
          ...
          <View style={styles.walletDetails}>
            ...
            <View style={styles.amountContainer2}>
              {showBalances ? (
                <>
                  <Text
                    style={styles.propertiesBalance}
                    adjustsFontSizeToFit={true}
                    numberOfLines={1}
                  >
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (accountBalances.properties == 0) {
                    Alert.alert(
                      "Sell Property",
                      "You're yet to acquire any property. Keep growing your funds."
                    );
                  } else {
        ...
        >
          <View style={styles.walletDetails}>
            ...
            <Text style={styles.walletMessage}>
              Withdraw for <Text style={{ color: "#43FF8E" }}>free</Text>{" "}
              anytime
            </Text>
            ...
            {userTransactions.some((transaction) =>
              ...
              <View style={styles.noTransactionsContainer}>
                <Text style={styles.noTransactionsMessage}>
                  You're yet to make any withdrawals.
                </Text>
              </View>
            )}
          </View>
