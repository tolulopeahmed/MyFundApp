...
const QuickSaveModal = ({
  ...
  const handleBankTransfer = async () => {
    try {
      ...
      const response = await axios.post(
        `${ipAddress}/api/initiate-save-transfer/`,
        requestData,
        {
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        const successMessage =
          "Your QuickSave request is pending approval and will be processed shortly. Check transactions for confirmation.";
        const messageData = {
          text: successMessage,
          date: messageDate,
          time: messageTime,
        ...
        Alert.alert(
          "QuickSave Request Successful",
          "Your bank transfer has been initiated and will be processed shortly once your payment (transfer) is confirmed."
        );
      } else {
  ...
  return (
    <>
              ...
              <View style={styles.modalContent}>
                ...
                >
                  ...
                  <Ionicons
                    ...
                    marginTop={22}
                    paddingRight={25}
                    onPress={() => setQuickSaveModalVisible(false)}
                  />
                </View>
                <Divider />
                ...
                <View style={styles.presetAmountsContainer}>
                  <View style={styles.presetAmountColumn}>
                    <TouchableOpacity
                      ...
                      onPress={() => handleAmountButtonPress(5000)}
                    >
                      <Text style={styles.presetAmountText}>5,000</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={styles.presetAmountButton}
                      onPress={() => handleAmountButtonPress(20000)}
                    >
                  ...
                  <View style={styles.presetAmountColumn}>
                    <TouchableOpacity
                      style={styles.presetAmountButton}
                      onPress={() => handleAmountButtonPress(10000)}
                    >
                      <Text style={styles.presetAmountText}>10,000</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={styles.presetAmountButton}
                      onPress={() => handleAmountButtonPress(40000)}
                    >
                  ...
                  <View style={styles.presetAmountColumn}>
                    <TouchableOpacity
                      style={styles.presetAmountButton}
                      onPress={() => handleAmountButtonPress(15000)}
                    >
      ...
      <PinModal
        ...
        useMode="validate"
        onPinSubmit={showQuickSaveButton ? handleQuickSave : handleBankTransfer}
      />
    </>
  );
};
