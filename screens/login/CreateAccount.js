...
const CreateAccount = ({ route, navigation }) => {
  ...
  const validateFirstName = (firstName) => {
    ...
    setValidFirstName(
      trimmedFirstName && /^[a-zA-Z0-9]+$/.test(trimmedFirstName)
    );
    setIsFormTouched(true);
  };
      ...
      if (error.response) {
        ...
        if (error.response.status === 400) {
          if (error.response.data.email) {
            alert(
              'A MyFund user is already using this email. Kindly use another email to create your account. If in doubt, kindly return to the login screen and select "Forgot Password?"'
            );
          } else if (
          ...
          >
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.subText}>
                ...
                every January and July. Own properties and earn a{" "}
                <Text style={{ fontFamily: "proxima" }}>
                  lifetime rental income{" "}
                </Text>
                on MyFund. Signup here.
              </Text>
            </View>
            ...
            <View style={styles.fieldContainer2}>
              ...
              <View style={styles.inputContainer}>
                <TextInput
                  style={[
                    styles.input2,
                    !validPhoneNumber && styles.invalidInput,
                  ]}
                ...
                <View style={styles.pickerContainer}>
                  <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) =>
                      setHowDidYouHear({ value: itemValue, isValid: true })
                    }
                  >
                    <Picker.Item
                      label="How did you hear about MyFund?"
                      value=""
                    />
                    <Picker.Item
                    ...
                    />
                    <Picker.Item
                      label="Instant Messaging - Whatsapp, Telegram, etc."
                      value="IMs"
                    />
