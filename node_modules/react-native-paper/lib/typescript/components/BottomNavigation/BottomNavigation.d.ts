...
import { Animated, ColorValue, EasingFunction, StyleProp, TouchableWithoutFeedbackProps, ViewStyle } from 'react-native';
...
declare type TouchableProps<Route extends BaseRoute> = TouchableWithoutFeedbackProps & {
    key: string;
    route: Route;
...
declare const BottomNavigation: {
    <Route extends BaseRoute>({ navigationState, renderScene, renderIcon, renderLabel, renderTouchable, getLabelText, getBadge, getColor, getAccessibilityLabel, getTestID, activeColor, inactiveColor, keyboardHidesNavigationBar, barStyle, labeled, style, sceneAnimationEnabled, sceneAnimationType, sceneAnimationEasing, onTabPress, onTabLongPress, onIndexChange, shifting: shiftingProp, safeAreaInsets, labelMaxFontSizeMultiplier, compact: compactProp, testID, theme: themeOverrides, getLazy, }: Props<Route>): JSX.Element;
    /**
