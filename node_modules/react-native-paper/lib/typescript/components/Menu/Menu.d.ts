...
declare class Menu extends React.Component<Props, State> {
    static Item: {
        ({ leadingIcon, trailingIcon, dense, title, disabled, onPress, style, contentStyle, titleStyle, rippleColor: customRippleColor, testID, accessibilityLabel, accessibilityState, theme: themeOverrides, titleMaxFontSizeMultiplier, }: import("./MenuItem").Props): JSX.Element;
        displayName: string;
    };
    static defaultProps: {
        statusBarHeight: any;
...
declare const _default: React.ComponentType<Pick<Props, "style" | "children" | "anchor" | "testID" | "visible" | "keyboardShouldPersistTaps" | "contentStyle" | "anchorPosition" | "statusBarHeight" | "onDismiss" | "overlayAccessibilityLabel"> & {
